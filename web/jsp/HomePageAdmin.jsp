<%-- 
    Document   : HomePage
    Created on : Apr 10, 2021, 3:02:51 PM
    Author     : amani
--%>
...
<html data-wf-page="606742758fc6074e25108ff0" data-wf-site="606729d15837e87029637bf6">
  ...
  <link href="images/webclip.png" rel="apple-touch-icon">
    ...
    <a href="#" class="logo-link w-nav-brand">
      <h1 class="brand-text">KAUH</h1><img src="../images/logo.png" loading="lazy" width="50" height="50" alt="" class="image-5">
    </a>
      ...
      <div class="tabs-content w-tab-content">
          <div data-w-tab="Tab 1" class="tab-pane-tab-1 w-tab-pane w--tab-active">
                  <table>                    
                      <tbody>
                      <tr>
                          <td><a href="addingNewRoom1.jsp">add new Room</a><img src="../images/add.jpg" width="17" alt="" class="image"></d>
                      </tr>
                      <tr>
                          <td><a href="changeRoomInfo1.jsp">Updat Room info</a><img src="../images/update.png" width="17" alt="" class="image-3"></d>
                      </tr>
                      <tr>
                          <td><a href="bedState1.jsp">Update Bed info</a><img src="../images/update.png" width="17" alt="" class="image-3"></d>
                      </tr>
                      <tr>
                          <td><a href="showRoom.jsp">Show Rooms</a><img src="../images/show.jpg" width="17" alt="" class="image-3"></d>
                      </tr>
                     <tr>
                          <td><a href="showbed.jsp">Show Beds</a><img src="../images/show.jpg" width="17" alt="" class="image-4"></d>
                      </tr>
