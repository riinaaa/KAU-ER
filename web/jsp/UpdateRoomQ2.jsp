<%-- 
    Document   : UpdateRoomQ2
    Created on : Apr 10, 2021, 1:26:12 AM
    Author     : amani
--%>
...
<div class="content">
    ...
    <div data-duration-in="300" data-duration-out="100" class="tabs w-tabs">
      <div class="tabs-menu w-tab-menu">
           ...
           <form name="UpdateRoomQ2" action="showRoom.jsp" method="POST">
        <% 
            ...
            boolean isAdded = conn.updatebedQ(room1, bed1,state,name);
            if(isAdded==true)
