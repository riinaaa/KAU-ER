<%-- 
    Document   : UpdateRoomQ1
    Created on : Apr 10, 2021, 1:07:58 AM
    Author     : amani
--%>
...
String roomName = result.getNString("roomName");
 ...
 <form action ="UpdatingRoom2.jsp" method="POST">
                 ...
                 <div><label for="numberOfbeds" class="field-label">beds:</label><input value="<%= bedQ%>" type="text" class="text-field w-input" maxlength="256" name="numberOfbeds" data-name="number Of beds" placeholder="number Of beds" id="lName-2">
           
                        <div><label for="state" class="field-label">state:</label><output value="<%=state%>" type="text" class="text-field w-input" maxlength="256" name="state" data-name="state" placeholder="state" id="fName2">
                            <%out.print(state);%></div>
                                <input type="hidden" name="ID" value="<%=room%>" size="45" />
                         <input type="hidden" name="state" value="<%=state%>" size="45" />
