<%-- 
    Document   : UpdateBedQ
    Created on : Apr 3, 2021, 6:39:40 AM
    Author     : amani
--%>
...
<body>
    ...
    <div class="content">
        <h1 class="heading">Change room Info</h1>
                ...
                <table>  
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="UpdatingRoom1.jsp?roomNumber=<%= result.getInt("roomNumber")%>">Update State</a> 
                                <a href="UpdateRoomQ1.jsp?roomNumber=<%=result.getInt("roomNumber")%>"> Update Beds Quantity</a>
                            </td>
                        </tr>
                        <% } 
                        user.close();
