<%-- 
    Document   : adding
    Created on : Apr 3, 2021, 6:13:13 AM
    Author     : amani
--%>
...
<div class="content">
    ...
    <div data-duration-in="300" data-duration-out="100" class="tabs w-tabs">
     ...
     <form name="addingNewRoom1" action="addingNewRoom2.jsp" method="POST">
         <div><label for="room" class="field-label">room Name:</label><input type="text" class="text-field w-input" maxlength="256" name="room" data-name="room Name" placeholder="room Name" id="fName2"></div>
        <div><label for="bed" class="field-label">beds:</label><input type="text" class="text-field w-input" maxlength="256" name="bed" data-name="bed" placeholder="bed" id="lName-2"></div>
        <div><input type="submit" value="OK" name="OK" /></div>
        <div><input type="reset" value="cancle" name="Reset" /></div>
     </form>
