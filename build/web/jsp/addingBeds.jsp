<%-- 
    Document   : addingBeds
    Created on : Apr 9, 2021, 9:07:33 PM
    Author     : amani
--%>
...
<div class="content">
    ...
    <body>
                <form name="addingBeds" action="showRoom.jsp" method="POST">
        <%
           String ID = session.getAttribute("roomID").toString();
           String quantity = session.getAttribute("bedNum").toString();
           int bed1= Integer.parseInt(quantity);
            int room= Integer.parseInt(ID);
           Java.DB.DB_Connection conn = new Java.DB.DB_Connection();
            for (int i = 0; i < bed1; i++) {
                    conn.addBed(i , room ,"1806231" );
                } 
   out.print("Beds are added!");
            %>
