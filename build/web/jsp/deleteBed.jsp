<%-- 
    Document   : deleteBed
    Created on : Apr 12, 2021, 9:34:21 PM
    Author     : amani
--%>
...
<div class="content">
    <h1 class="heading">delete bed</h1>
    <div data-duration-in="300" data-duration-out="100" class="tabs w-tabs">
      <div class="tabs-menu w-tab-menu">
           
       
      </div>
          <form action ="showbed.jsp" method="POST">
        <% 
        ...
        System.out.println(bedID);
         ...
         user.deleteBed(Integer.parseInt(room),Integer.parseInt(bedID));
           System.out.println("bb");
         out.print("bed is deleted!");
          %>
